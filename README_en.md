...
The repository build metadata specifies `API22` as the target version and declares `API12` as the minimum compatible version. The minimum SDK version required for compilation and runtime compatibility with older ROM versions have not been recorded.
